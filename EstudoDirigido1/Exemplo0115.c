...
int main(int argc, char *argv[])
{
    ...
    //Mostrar Resultado
    printf ("%s%lf%s%lf%s%lf", "Se supormos que ", n1, " seja a base de um triangulo e ", n2, " seja 5 vezes a altura de um triangulo\nentao a area do mesmo sera: ", a);
