/*
 2022-1_aed1_ed14 - v0.0. - 24 / 06 / 2022
 Author: 779139 - Pedro Marcelo Ciriaco Moura

 Para compilar em terminal (janela de comandos):
 Linux : g++ -o 2022-1_aed1_ed14 2022-1_aed1_ed14.cpp
 Windows: g++ -o 2022-1_aed1_ed14 2022-1_aed1_ed14.cpp
 Para executar em terminal (janela de comandos):
 Linux : ./2022-1_aed1_ed14
 Windows: 2022-1_aed1_ed14
*/
...
void method13()
{
    ...
    if (n)
    {
        cout << "\nO valor logico digitado eh verdadeiro";
    }
    else
    {
        cout << "\nO valor digitado eh invalido ou falso";
    }
    getchar();
    IO_pause("\nAperte ENTER para continuar");
}
