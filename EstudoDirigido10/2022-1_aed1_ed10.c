/*
 2022-1_aed1_ed10 - v0.0. - 02 / 05 / 2022
 Author: 779139 - Pedro Marcelo Ciriaco Moura

 Para compilar em terminal (janela de comandos):
 Linux : gcc -o 2022-1_aed1_ed10 2022-1_aed1_ed10.c
 Windows: gcc -o 2022-1_aed1_ed10 2022-1_aed1_ed10.c
 Para executar em terminal (janela de comandos):
 Linux : ./2022-1_aed1_ed10
 Windows: 2022-1_aed1_ed10
*/
...
ref_M_INTS m_INTS_produtomatrizes(ref_M_INTS matriz, ref_M_INTS matriz2, ref_M_INTS matriz3)
{
    ...
    if (tamanho1 == tamanho2)
    {
        ...
        {
            matriz3->data[i][x] = 0;
            for (y = 0; y < tamanho3; y++)
            {
                matriz3 ->data[i][x] = matriz3 ->data[i][x] + (matriz->data[i][y] * matriz2->data[y][x]);
            }
        }
        }
...
int main(int argc, char *argv[])
{
    ...
    do
    {
        printf("\n");
        printf("0 - Parar\n");
        printf("1 - Gerador de arranjo aleatorio por intervalo (EXERCICIO 1)\n");
        printf("2 - Mostrar arranjo.\n");
        printf("3 - Procurar valor em arquivo (EXERCICIO 2)\n");
        printf("4 - Comparar arranjos (EXERCICIO 3)\n");
        printf("5 - Somar arranjos (EXERCICIO 4)\n");
        printf("6 - Testar se arranjo esta em ordem crescente (EXERCICIO 5)\n");
        printf("7 - Criar matriz\n");
        printf("8 - Mostrar matriz\n");
        printf("9 - Gravar matriz em arquivo\n");
        printf("10 - Ler matriz de arquivo\n");
        printf("11 - Obter transposta de matriz (EXERCICIO 6)\n");
        printf("12 - Testar se valores da matriz sao iguais a zero (EXERCICIO 7)\n");
        printf("13 - Testar igualdade de duas matrizes (EXERCICIO 8)\n");
        printf("14 - Somar matrizes (EXERCICIO 9)\n");
        printf("15 - Tirar o produto de duas matrizes (EXERCICIO 10)\n");
