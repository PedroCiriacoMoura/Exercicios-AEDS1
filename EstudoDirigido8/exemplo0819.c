/*
 exemplo0819 - v0.0. - 02 / 05 / 2022
 Author: 779139 - Pedro Marcelo Ciriaco Moura

 Para compilar em terminal (janela de comandos):
 Linux : gcc -o exemplo0819 exemplo0819.c
 Windows: gcc -o exemplo0819 exemplo0819.c
...
void array09 (int tamanho, int arranjo [])
{
    ...
    if (teste)
    {
        printf ("Valor %d foi encontrado e esta na posicao %d do arranjo",x, i-1 );
    }else{
        printf ("Valor nao encontrado.");
    }
    printf ("\n");
