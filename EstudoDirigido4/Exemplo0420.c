...
int funcao07(char string[])
{
    ...
    printf("\n%d Digitos pares",qntd);
    return (0);
}
void method07()
{
    char *x;
    x = IO_readstring("Entrar com uma cadeia de caracter: ");
    int y = funcao07(x);
...
int funcao08(char string[])
{
    ...
    while (string[x] != '\0')
    {
        ...
        if (!(('A' <= string[x] && string[x] <= 'Z') || ('a' <= string[x] && string[x] <= 'z') || ('0' <= string[x] && string[x] <= '9')))
        {
...
{
    char *x;
    x = IO_readstring("Entrar com um caracter: ");
    int y = funcao08(x);
...
IO_println ( "6 - Mostrar as letras menores que 'K' e 'k' separadas por uma funcao definida para receber uma cadeia de caracteres como parametro." );
...
IO_println ( "8 - Mostrar todos os simbolos nao alfanumericos em uma cadeia de caracteres separados por meio de uma funcao" );
IO_println ( "9 - Mostrar todos os simbolos alfanumericos em uma cadeia de caracteres separados por meio de uma funcao. " );
IO_println ( "10 - Mostrar e contar a quantidade de simbolos alfanumericos em cada palavra, e calcular o total de todas as palavras, por meio de uma funcao." );
