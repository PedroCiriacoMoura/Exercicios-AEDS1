/*
 Exemplo0513 - v0.0. - 09 / 04 / 2022
 Author: 779139_PEDRO_MARCELO_CIRIACO_MOURA
 Para compilar em terminal (janela de comandos):
 Linux : gcc -o exemplo0513 exemplo0513.c
 Windows: gcc -o exemplo0513 exemplo0513.c
...
int main()
{
    ...
    do
    {
        ...
        IO_println("3 - Mostrar a quantidade em valores ímpares múltiplos de 7 em ordem decrescente");
        IO_println("");
