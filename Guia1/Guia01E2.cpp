...
Professor, eu ja estava usando o metodo crescente nas repetições, então, usei o metodo
decrescente para usar o inverso do que eu estava usando.
---------------------------------------------- previsao de testes
---------------------------------------------- historico
