...
int main()
{
    ...
    if (x >= 10 && x <= 19)
    {
        printf("%i pertence ao intervalo de (10:25)\n", x);
    }
    else
    {
        if (x >= 26 && x <= 40)
        {
            printf("%i pertence ao intervalo de (20:40)\n", x);
        }
        else
        {
            if (x >= 20 && x <= 25)
            {
                printf("%i pertence aos dois intervalos (10:25) e (20:40)\n", x);
            }
            else
            {
                printf("%i nao pertence aos dois intervalos (10:25) e (20:40)\n", x);
            }
        }
    }
}
