...
void method12()
{
    ...
    int t = 0;
    int contador = 0;
    printf("Entre com uma cadeira de caracteres: ");
    gets(s);
    t = strlen(s);
    for (int i = 0; i < t; i++)
    {
    ...
    {
        printf("\n");
        printf("A sequencia escrita tinha apenas simbolos que nao sao letras.");
        printf("\n");
    }
    else
    {
        printf("\n");
        printf("A sequencia escrita nao tinha apenas simbolos que nao sao letras.");
        printf("\n");
    }
}
...
int main(void)
{
    ...
    do
    {
        ...
        IO_println("12 - Teste se uma cadeia de caracteres contem apenas simbolos que nao sao letras");
        IO_println("");
